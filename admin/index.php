                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">WEEKLY SALES</div>
                                        <div class="item-number"><span class="counter" data-num="150000">$5000</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">MOUNTHLY SALES</div>
                                        <div class="item-number"><span class="counter" data-num="2250">$15000</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="dashboard-summery-one mg-b-20">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        <div class="item-title">Half SALES</div>
                                        <div class="item-number"><span class="counter" data-num="5690">$30000</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="student-report">
                                    <div class="student-count pseudo-bg-blue">
                                        <h4 class="item-title">Female Customer</h4>
                                        <div class="item-number">45,000</div>
                                    </div>
                                    <div class="student-count pseudo-bg-yellow">
                                        <h4 class="item-title">Male Customer</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="notice-box-wrap">
                                    <div class="notice-list">
                                        ...
                                        <h6 class="notice-title"><a href="#">Great web site to go on vacation.</a></h6>
