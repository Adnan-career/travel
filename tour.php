...
<div class="container-fluid">
   <div class="row align-items-center justify-content-center"  style="height: 700px; background-image: url(img/austin-distel-599272-unsplash.jpg); background-size: 100% 100%;">
      <div class="col-sm-12">
        <h1 class="text-center display-2 text-warning"><b>Destination</b></h1>
