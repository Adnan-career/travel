...
<div class="container-fluid">
	 <div class="row align-items-center justify-content-center"  style="height: 700px; background-image: url(img/image_7.jpg); background-size: 100% 100%;">
      <div class="col-sm-12">
        <h1 class="text-center display-2 text-white "><b>Discount</b></h1>
